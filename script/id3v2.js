  ...
  id3v23 = (function() {
    ...
    id3v23.prototype.getFrames = function() {
      ...
      for (tag in _ref) {
        ...
        if (blankLength > 0) {
          frame.write(repeatString(hex([0x00]), blankLength), 4, blankLength, 'utf8');
        }
    ...
    id3v23.prototype.getSize = function() {
      ...
      return fs.readFile(filename, (function(_this) {
        return function(err, oldData) {
          return fs.open(filename, 'w+', function(err, fd) {
            ...
            if (blankLength > 0) {
              header.write(repeatString(hex([0x00]), blankLength), 6, blankLength, 'utf8');
            }
